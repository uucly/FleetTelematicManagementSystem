package de.master.masterthesis;
...
public class Start
{
	...
	{
		ResourceBundle portProperties = ResourceBundle.getBundle("port", Locale.getDefault());
		...
		http_config.setSecurePort(Integer.valueOf(portProperties.getString("securePort")));
		http_config.setOutputBufferSize(32768);

		ServerConnector http = new ServerConnector(server, new HttpConnectionFactory(http_config));
		http.setPort(Integer.valueOf(portProperties.getString("port")));
		...
		if (keystore != null && keystore.exists()) {
			...
			System.out.println(
					"SSL access to the examples has been enabled on port " + portProperties.getString("securePort"));
			System.out.println("You can access the application using SSL on https://localhost:"
					+ portProperties.getString("securePort"));
			System.out.println();
		}
